...
public class CompactCalendarTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.jadwal_main_tab,container,false);

        judul=(TextView)v.findViewById(R.id.jadwal_judul);
        ...
        judul.setText(dateFormatForMonth.format(compactCalendarView.getFirstDayOfCurrentMonth()));
        //set initial title
        ...
        compactCalendarView.setListener(new CompactCalendarView.CompactCalendarViewListener() {
            ...
            public void onDayClick(Date dateClicked) {
                ...
                judul.setText(dateFormatForMonth.format(dateClicked));
            ...
            public void onMonthScroll(Date firstDayOfNewMonth) {
                ...
                judul.setText(dateFormatForMonth.format(firstDayOfNewMonth));
            }
        });
    ...
    public void onResume() {
      ...
      //  toolbar.setTitle(dateFormatForMonth.format(compactCalendarView.getFirstDayOfCurrentMonth()));
        ...
        judul.setText(dateFormatForMonth.format(new Date()));
    }
